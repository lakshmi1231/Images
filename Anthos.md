...
## 3.2. Installation Guide (Hybrid Mode)
...
## 3.3. Logging into anthos cluster
...
## 3.5	Creating google cloud service account keys.
...
#### Step 7: Add Service Account Key
#### Step 8: Choose Key Type
#### Step 9: Create the Key
#### Step 10: Save the Key Securely
#### Step 11: Configure Anthos with the Key
